...
<section class="banner-bottom py-5">
	<div class="container py-md-3">
		<div class="heading style1">
                    <h4 align="left"> Select The Unit </div> 
		<h4>
                        
                        <table width="739" height="145"> 
                            <tr>
                                <td width="161" height="69"> Unit Number</td>
...
<%
	...
	%>
        ...
        <tr>
            <td height="68"> <a href="adminviewunitmembers.jsp?unitid=<%=unitid%>">
                    
		  <%out.print(unitid);%> 
		  
          </td>
            <td> 
		  <%out.print(rs.getString("unitname"));%> 

            </td>
			<td> <a href="adminviewunitproducts.jsp?unitid=<%=unitid%>">View Their Products </a></td>
            </tr>                        
