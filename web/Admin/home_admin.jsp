<%-- 
    Document   : home_admin
    Created on : Oct 4, 2018, 10:29:49 PM
    Author     : USER
--%>
				  ...
				  <li class="nav-item active">
				   ...
				   <li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  ...
					  <a class="dropdown-item" href="../CAN/adsviewform.jsp">ADS</a>
					  <a class="dropdown-item" href="../CAN/nhgviewform.jsp">NHG</a>
					</div>
				  </li>
	...
	<div class="container">
		<div class="row banner-grids">
			<div class="col-lg-6 banner-info">
                            ...
                            <a href="#">Hiiii Admin!!!!</a><br><br>
                            
                                
			</div>
			<div class="col-lg-6 col-md-9 banner-image">
				<img src="../images/admin4.png" alt="" class="img-fluid"/>
			</div>
		</div>
	</div>
</section>
