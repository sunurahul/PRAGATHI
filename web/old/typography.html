...
<html lang="en">
<head>
<title>Work Business Category Flat Bootstrap Responsive Website Template | Typography :: w3layouts</title>
<!-- for-mobile-apps -->
								...
								<div class="card-header card-header-primary">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="profile">
											<p> Donec auctor diam quis lectus scelerisque porta. Suspendisse rhoncus, nunc quis facilisis ullamcorper, libero libero finibus mauris, ac hendrerit nulla massa at leo. Sed accumsan turpis id placerat maximus. Etiam tincidunt porttitor tristique. </p>
										</div>
										<div class="tab-pane" id="messages">
											<p>  Nunc quis nunc eget mauris laoreet faucibus nec eget eros. Maecenas malesuada faucibus enim, nec varius massa consectetur ac. Fusce fermentum interdum magna nunc. Vestibulum ac nunc elementum, mollis turpis id, viverra.</p>
										</div>
										<div class="tab-pane" id="settings">
											<p> Suspendisse rhoncus, nunc quis facilisis ullamcorper, Donec auctor diam quis lectus scelerisque porta. libero libero finibus mauris, ac hendrerit nulla massa at leo. Etiam tincidunt Sed porttitor tristique. accumsan turpis id placerat maximus </p>
										</div>
									</div>
								</div></div>
