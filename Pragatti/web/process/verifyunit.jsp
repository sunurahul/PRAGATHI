...
<%
   ...
   psmt.setInt(1,userid);
   res=psmt.executeUpdate();
   out.print("may prob here");
   psmt=con.prepareStatement("insert into tbl_mempayment(userid,totpay)"+"values(?,?)");
   psmt.setInt(1,userid);
   psmt.setInt(2,0);
   res=psmt.executeUpdate();
   ...
   if(rs.next())
        ...
        {
        psmt=con.prepareStatement("insert into tbl_ads(wardno,ads_id)"+"values(?,?)");
        psmt.setInt(1,wardno);
        psmt.setInt(2,0);
        res=psmt.executeUpdate();
        }
