...
<%
   ...
   psmt=con.prepareStatement("update tbl_loans set verifyby=?,status='ADS Rejected' where loanid=?");
   psmt.setInt(1,userid);
   psmt.setInt(2,loanid);
   res=psmt.executeUpdate();
  
   response.sendRedirect("../CAN/adsloans.jsp?msg=Rejected Successfully");     
