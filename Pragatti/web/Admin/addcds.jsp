...
<section class="banner">
	...
	<form name="form1" method="get" onSubmit="return validation()" action="addcds2.jsp">
...
<%
    ...
    if(rs.next())
    {
        response.sendRedirect("ads-cds.jsp?msg=Already a CDS Appointed pleas update if any change");
    }
...
%> </div></td>
          ...
          <tr>
            <td height="50" colspan="2"><div align="center" class="style10">ADD CDS </div></td>
          </tr>
          <tr>
            <td height="48">Select ADS ID</td>
            <td><label><span class="icon2">
              <select name="ads_id" id="ads_id">
                <option>-Select Your Unit-</option>
                <%              
		String unitname=null;
		int unitid=0;
		psmt=con.prepareStatement("select * from tbl_ads");
		rs=psmt.executeQuery();
		while(rs.next())
		{
		...
		out.println("<option value="+rs.getInt("ads_id")+">"+rs.getInt("ads_id")+"</option>");
		}
