<%-- 
    Document   : paliative
    Created on : 29 Oct, 2018, 11:27:20 AM
    Author     : user
--%>
...
<section class="latest-news py-5">
	<div class="container py-md-5">
		<div class="heading">
			<h3 class="head text-center">Agriculture </h3>
			<p class="my-3 head text-center"> Aims at increasing the visibility of women in agriculture,and providing a livelihood opportunity by adopting sustainable and eco friendly agriculture. </p>
		</div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="blog-post mb-4">
					...
					<img src="../images/agri1.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Organic farming of spinach</a>
			...
			<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/agri2.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Plantain farming</a>
			...
			<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/agri3.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Organic Vegetable farming</a>
			...
			<div class="col-lg-4 col-md-6 mt-5 pt-lg-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/agri4.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#"> Won award for best farmers</a>
			...
			<div class="col-lg-4 col-md-6 mt-5 pt-lg-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/agri5.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Paddy farming</a>
			...
			<div class="col-lg-4 col-md-6 mt-5 pt-lg-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/agri6.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Floriculture</a>
			...
			<div class="col-lg-4 col-md-6 mt-5 pt-lg-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/agri7.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Diary farming</a>
			...
			<div class="col-lg-4 col-md-6 mt-5 pt-lg-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/agri8.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Beans farming</a>
			...
			<div class="col-lg-4 col-md-6 mt-5 pt-lg-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/agri9.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Goat farming</a>
