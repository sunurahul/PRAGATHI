...
<section class="banner">
	<div class="container">
		<div class="row banner-grids">
                    <table width="1091">
                        <th width="147" height="48"><span class="style9"> Name </span></th>
                        <th width="157"><span class="style9"> Ward Number </span></th>
                        <th width="134"><span class="style9"> Unit Name (No) </span></th>
                        <th width="207"><span class="style9"> Address </span></th>
                        <th width="163"><span class="style9"> phone </span></th>
                        <th width="113"><span class="style9"> Aadhar </span></th>
                        <th width="138"> </th>
...
%>
          <tr>    
              ...
              <td> <div align="center"><a href="../process/verifymember.jsp?userid=<%=userid%>&&unitid=<%=unitid%>"> Verify </a> &nbsp;&nbsp;&nbsp;<a href="../process/rejectmember.jsp?userid=<%=userid%>">Reject </a> </div></td>
          </tr>
 <%
    }
    }
