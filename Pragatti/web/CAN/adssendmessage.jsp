...
<form id="form1" name="form1" method="post" onSubmit="return validation()" action="../process/adssendmessage.jsp">
            ...
            <tr>
              ...
              <td width="205"> <div align="left">
                ...
                <select name="msgto" id="msgto">
                  ...
                  <option value="allunitmembers">ALl Unit Members</option>
                  <option value="unitadmins">All Unit Admins</option>
                  <option value="cds">CDS</option>
                  <option value="admin">Admin</option>
                </select>
                </label>
                <input type="hidden" name="usertype" required="" value="ads">
...
<!-- copyright -->
    ...
    function validation()
    {
        ...
        if(document.form1.msgto.selectedIndex==0||document.form1.msgto.value=="")
      	  {
           alert("You must select recepient type");
           return false;
        }       
