...
<%
    ...
    out.print(usertype);
        if(usertype.equals("ads")||usertype.equals("cds"))
        {
            out.print(usertype);
        response.sendRedirect("unitadminhome.jsp?msg=You are an "+usertype+" so cant be change designation");
	...
	%>
              ...
              <td width="119" height="62"> <div align="left" class="style2 style3">Member ID</div></td>
              <td width="212" height="62"> <div align="left" class="style4">Name</div></td>
              <td width="184" height="62"> <div align="left" class="style4">Address</div></td>
              <td width="180" height="62"> <div align="left" class="style4">Phone</div></td>
              <td width="196"> </td>
            </tr>
...
%>
            ...
            <tr>
              <td height="46"> <div align="left" class="style4"><%out.print(uid);%></div></td>
              <td height="46"> <div align="left" class="style4">
                <a href="unitmemberdetails.jsp?userid=<%=uid%>">
              ...
              <td> <a href="../process/code_changedesignation.jsp?unitid=<%=unitid%>&&userid=<%=uid%>"> <%if(uid!=userid) out.print("Select"); %> </a></td>
            </tr>   
