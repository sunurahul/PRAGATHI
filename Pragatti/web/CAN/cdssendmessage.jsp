...
<form id="form1" name="form1" method="post" onSubmit="return validation()" action="../process/cdssendmessage.jsp">
            ...
            <tr>
              ...
              <td width="205"> <div align="left">
                ...
                <select name="msgto" id="msgto">
                  ...
                  <option value="allunitadmins">Al unitadmins</option>
                  <option value="admin">Admin</option>
                </select>
                </label>
                <input type="hidden" name="usertype" required="" value="cds">
