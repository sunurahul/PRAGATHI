...
<section class="banner-bottom py-5">
	<div class="container py-md-3">
		<div class="heading">
                    <h4 align="left"> <a href="applyproducts.jsp">Apply for new product</a> </div> <h4>
					<h4 align="right"> <a href="appliedproducts.jsp">Applied product</a> </div> <h4>
...
<%
    ...
    int unitid=0,pid=0;
    psmt=con.prepareStatement("select * from tbl_member where userid=(select userid from tbl_login where username=?)");    
    ...
    psmt=con.prepareStatement("select * from tbl_product where unitid=? and status='Verified'");
    ...
    %>
			<div class="col-lg-4 col-md-6">
				...
				<p class="mb-4"><%out.print(rs.getString("descri"));%></p>
			</div>
                        <%
}
              %>
