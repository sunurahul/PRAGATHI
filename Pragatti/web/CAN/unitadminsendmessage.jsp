...
<form id="form1" name="form1" method="post" onSubmit="return validation()" action="../process/unitadminsendmessage.jsp">
            ...
            <tr>
              ...
              <td width="205"> <div align="left">
                ...
                <select name="msgto" id="msgto">
                  ...
                  <option value="members">To Members</option>
                  <option value="ads">ADS</option>
                  <option value="cds">CDS</option>
                  <option value="admin">Admin</option>
                </select>
                </label>
                <input type="hidden" name="usertype" required="" value="unitadmin">
