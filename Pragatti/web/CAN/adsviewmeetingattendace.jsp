...
<%
	...
	<div align="center">
            ...
            <tr>
     <td width="122" height="62"> <div align="left" class="style2 style3 style1">Present Members</div></td>
     

            </tr>
             
<%
psmt=con.prepareStatement("select * from tbl_attendance where mid=? and attendance='Present'");
psmt.setInt(1,mid);
...
%>
            ...
            <tr>
              <td height="46"> <div align="left" class="style4"><%out.print(rs1.getString("name"));%></div></td>
...
<tr>
     <td width="122" height="62"> <div align="left" class="style2 style3 style1">Absent Members</div></td>
     

            </tr>
             
<%
psmt=con.prepareStatement("select * from tbl_attendance where mid=? and attendance='Absent'");
psmt.setInt(1,mid);
rs=psmt.executeQuery();
while(rs.next())
{
