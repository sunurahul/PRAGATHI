...
%> </h5><br>
            <h4 align="right"><a href="adssendmessage.jsp">Send a Messages</a></h4>
			<h3>Messages</h3>
    </div>
...
<%
    ...
    psmt=con.prepareStatement("select * from tbl_messagedetails where totype='ads' and toid=?");
    psmt.setInt(1,uid);
	...
	%>
            <tr>
              ...
              <td height="62"><a href="../process/deletemsg.jsp?id=<%=id%>&&utype=ads">Delete</a></td>
            </tr>
            <%}}}
    }
 catch(Exception e)
