...
%> </h5><br>
            <h4 align="right"><a href="unitadminsendmessage.jsp">Send a Messages</a></h4>
			<h3>Messages</h3>
    </div>
...
<%
    ...
    String utype="admin",name=null;
    
    psmt=con.prepareStatement("select * from tbl_messagedetails where totype='unitadmin' and toid=?");
    psmt.setInt(1,uid);
	...
	%>
            <tr>
              ...
              <td height="62"><%if((utype.equals("admin"))) out.print("admin"); else out.print(rs3.getString("name")+" ("+rs2.getString("usertype")+")");%></td>
              <td height="62"><a href="../process/deletemsg.jsp?id=<%=id%>&&utype=unit">Delete</a></td>
            </tr>
            <%}}}
    }
 catch(Exception e)
