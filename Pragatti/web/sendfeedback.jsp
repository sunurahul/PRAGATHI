...
%> </h5><br>
		...
		<h3>Send your Feedback</h3>
					...
					<form action="process/sendfeedback.jsp" method="post">
						<div class="icon1">
							<input placeholder="Name" name="name" type="text" required="">
						</div>
						<div class="icon2">
							<textarea name="feedback" cols="55" rows="2" placeholder="Feedback" required="" style="outline-style:inherit" ></textarea>
						</div>
			...
			<div class="col-lg-6 col-md-8 mx-auto">
				<img src="mages/women5.jpg" alt="" class="img-fluid"/>
			</div>
		</div>
	</div>
</section>
