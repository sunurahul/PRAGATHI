...
<%
	...
	<div align="center">
            ...
            <tr>
              ...
              <td width="122" height="62"> <div align="left" class="style2 style3">Date</div></td>
              <td width="222" height="62"> <div align="left" class="style4">Place of Meeing</div></td>
              <td> </td>
              
            </tr>
             
<%
psmt=con.prepareStatement("select * from tbl_unitmeetings where unitid=?");
...
%>
            ...
            <tr>
              <td height="46"> <div align="left" class="style4"><%out.print(rs.getString("date"));%></div></td>
              <td height="46"> <div align="left" class="style4"><%out.print(rs.getString("place"));%></div></td>
              <td> <a href="adsviewmeetingattendace.jsp?mid=<%=mid%>">View Attendance</a>
                     </td>
