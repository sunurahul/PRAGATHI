...
<%
    ...
    int totcount=0,totpay=0,precount=0,unitid=0,wardno=0;
...
<tr>
            ...
            <tr>
              <td height="46"><a href="../process/nhgleft.jsp?userid=<%=userid%>&&unitid=<%=unitid%>">Left and delete account </a></td>
              <td height="46"><a href="applyunitchange.jsp?wardno=<%=wardno%>&&unitid=<%=unitid%>">Apply for unit change</a> </td>
            </tr>
    </table>
</form>
