...
<%
    ...
    psmt=con.prepareStatement("select * from tbl_product where status='Verified' and unitid="+unitid+"");
    ...
    %>
			<div class="col-lg-4 col-md-6">
				<img src="../DisplayImageStaff?pid=<%=pid%>"   class="img-responsive" name="photo1" width="250" height="250" id="img1" >
                                ...
                                <p class="mb-4"><%out.print("ward Number "+wardno);%></p>
