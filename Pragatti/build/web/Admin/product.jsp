<%-- 
    Document   : product
    Created on : 29 Oct, 2018, 11:25:59 AM
    Author     : user
--%>
...
<section class="latest-news py-5">
	<div class="container py-md-5">
		<div class="heading">
			...
			<p class="my-3 head text-center"> Kudumbashree more recently has shown increasing in the interest in the promotion of self- employment through micro enterprises. </p>
		</div>
		<div class="row news_grids mx-auto mt-5 pt-3">
			<div class="col-lg-4 col-md-6">
				<div class="blog-post mb-4">
					...
					<img src="../images/snack1.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Homely Snacks</a>
					  <a class="dropdown-item" href="#">Price:75-300</a>
					</div>
				  </li>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/snack2.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  ...
					  <a class="dropdown-item" href="#">Price:40-100</a>
					</div>
				  </li>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/pickle.png" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Pickle</a>
					  <a class="dropdown-item" href="#">Price:92-200</a>
					</div>
				  </li>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mt-5 pt-lg-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/craft11.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Clay Craft</a>
					  <a class="dropdown-item" href="#">Price:450-1500</a>
					</div>
				  </li>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mt-5 pt-lg-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/craft5.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  ...
					  <a class="dropdown-item" href="#">Price:150-300</a>
					</div>
				  </li>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mt-5 pt-lg-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/soap.png" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Detergents and Cosmetics</a>
					  <a class="dropdown-item" href="#">Price:20-300</a>
					</div>
				  </li>
				</div>			
			...
			<div class="col-lg-4 col-md-6 mt-5 pt-lg-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/prdt1.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Candles</a>
					  <a class="dropdown-item" href="#">Price:25-100</a>
					</div>
				  </li>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mt-5 pt-lg-5">
				<div class="blog-post mb-4">
					...
					<img src="../images/chilli.jpg" alt="" class="img-fluid"/>
				</div>
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Curry Powder</a>
					  <a class="dropdown-item" href="#">Price:50-100</a>
					</div>
				  </li>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mt-5 pt-lg-5">
				...
				<div class="header-right">
					...
					<a href="#" class="contact">Read More</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="#">Dry fish</a>
					  <a class="dropdown-item" href="#">Price:25-50</a>
					</div>
				  </li>
				</div>
			</div>
