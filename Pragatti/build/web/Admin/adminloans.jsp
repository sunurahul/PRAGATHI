...
<%
    ...
    psmt=con.prepareStatement("select * from tbl_loans where status='ADS Verified'");
    ...
    {	loanid=rs.getInt("loanid");
        ...
        %>
            ...
            <tr>
                ...
                <td> <a href="adminunitmemberdetails.jsp?userid=<%=uid%>">
                <%out.print(rs1.getString("name"));%> 
                </a></td>
                <td> <a href="../process/adminverifyloan.jsp?loanid=<%=loanid%>" onClick="return fun_alert()">Verify</a> &nbsp;&nbsp;&nbsp;&nbsp;  <a href="../process/adminrejectloan.jsp?loanid=<%=loanid%>" onClick="return fun_alert()">Reject</a> </td>
