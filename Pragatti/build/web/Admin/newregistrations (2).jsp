	...
	<div class="container">
		<div class="row banner-grids">
			<div class="col-lg-6 banner-info">
                            <h4 class="">Select the category</h4><br> <br> 
				
                                <a href="newunitapplications.jsp">Unit Applications</a> <br><br><a href="newregapplications.jsp">Member Registration Applications</a>
			</div>
